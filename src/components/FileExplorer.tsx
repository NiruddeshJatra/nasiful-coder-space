...
export const files: FileItem[] = [
  ...
  { id: 'writing-tech-articles', name: 'tech-articles/', section: 'writing/tech-articles', icon: Folder, isContainer: true, parent: 'writing' },
  { id: 'writing-tech-series-01', name: 'the-machine-beneath-your-code/', section: 'writing/tech-articles/series-01', icon: Folder, isContainer: true, parent: 'writing-tech-articles' },
  { name: 'intro.md', section: 'writing/the-machine-beneath-your-code', icon: File, parent: 'writing-tech-series-01' },
  { name: 'whats-inside-a-bit.md', section: 'writing/whats-inside-a-bit', icon: File, parent: 'writing-tech-series-01' },
  { name: 'how-does-anything-become-bits.md', section: 'writing/how-does-anything-become-bits', icon: File, parent: 'writing-tech-series-01' },
  { name: 'cpu-blueprint.md', section: 'writing/cpu-blueprint', icon: File, parent: 'writing-tech-series-01' },
  { name: 'heartbeat-fde.md', section: 'writing/heartbeat-fde', icon: File, parent: 'writing-tech-series-01' },
  { name: 'memory-hierarchy.md', section: 'writing/memory-hierarchy', icon: File, parent: 'writing-tech-series-01' },
  { name: 'os-grand-conductor.md', section: 'writing/os-grand-conductor', icon: File, parent: 'writing-tech-series-01' },
  { name: 'code-to-machine-code.md', section: 'writing/code-to-machine-code', icon: File, parent: 'writing-tech-series-01' },
  { name: 'from-keypress-to-screen.md', section: 'writing/from-keypress-to-screen', icon: File, parent: 'writing-tech-series-01' },
