  ...
  const handleCommand = async (cmd: string) => {
    ...
    if (trimmedCmd === "fortune") {
      ...
      newHistory.push(
        ...
        "  cd tech-articles - Long-form series index",
        "  cd series-01     - The Machine Beneath Your Code (8 parts)",
      ...
      newHistory.push(
        ...
        "writing/tech-articles/the-machine-beneath-your-code/   (series-01, 8 parts)",
        "journey/running.md",
        "journey/hiking.md",
        "field-notes/",
        "photos/",
