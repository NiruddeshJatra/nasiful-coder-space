...
│   ├── widgets/          # Interactive instruments: NoiseVsBands, TransistorSwitch, GatePlayground, FeedbackLatch, ThreeBits, AbstractionStack, ProtagonistDisguises, PlaceValueBuilder, UnicodeEncodingDemo, PixelColorDemo, SamplingRateDemo, RLECompressionDemo, CPUBlindLens, AdderWidget, CPUDatapath, ClockVisualizer, InstructionAnatomy, ProgramCounterDemo, FetchDecodeExecute, InstructionCycleLoop, PipelineVisualizer
│   ├── content/          # Article content modules: SeriesHub, MachineBeneathYourCode, WhatsInsideABit, HowDoesAnythingBecomeBits, BlueprintOfACPU, HeartbeatFDE
